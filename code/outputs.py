...
def view_pipeline_output():
    """
    Reads and displays the contents of the Parquet files generated by the data pipeline.
    """
    try:
        ...
        print("Please ensure you have run the main 'datapipeline.py' script first to generate the output files.")
